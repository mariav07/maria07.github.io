/********************************************************************
  ...
  TODONE 2: JS is case sensitive. -- Remember how I showed  "ken" and "Ken" are not the same.
  ...
  TODONE 6: The game should end when the user unscrambles a word incorrectly
...
// Our master array of Halloween words. Note how it is declared as a CONST. That's becuase we don't want anything changing these values.
...
//Scramble the selectedWord and display it inside of a div called "scrambledWord"
 document.getElementById("scrambledWord").innerHTML = selectedWord
  ...
  .sort(() => Math.random() - 0.5) // This will ramdomly sort the array of letters
...
function check() {
  ...
  nextWord();
    ...
    game_over = true;
    alert("Game over! You unscrambled " + number + " words!")
  }
}
